...
const VIP_TIERS = [
  ...
  },
  {
    ...
    rakeback: 5,
    color: '#C0C0C0',
    perks: ['Silver chat badge', '5% rakeback on house fees', 'Priority support'],
  },
  {
    name: 'Gold',
    minWager: 25000,
    rakeback: 10,
    color: '#FFD700',
    perks: ['Gold tag in lobbies', '10% rakeback on house fees', 'Priority support'],
  },
  {
    name: 'Platinum',
    minWager: 100000,
    rakeback: 15,
    color: '#E5E4E2',
    perks: ['Platinum animated border', '15% rakeback on house fees', 'Priority support'],
  },
  {
    name: 'Diamond',
    minWager: 250000,
    rakeback: 20,
    color: '#B9F2FF',
    perks: ['Founding Whale badge', '20% rakeback on house fees', 'Zero withdrawal fees FOREVER', 'Private Discord access', 'Direct line to founders'],
          ...
          <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 80px)' }}>
            ...
            <div className="mb-6 p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
              <h3 className="font-bold text-white mb-2 flex items-center gap-2">
                <span className="text-green-400">💰</span> How Rakeback Works
              </h3>
              ...
              <div className="mt-3 p-3 bg-black/30 rounded-lg">
                <p className="text-gray-400 text-xs">
                  ...
                  {currentTierInfo.rakeback > 0 
                    ...
                    : <span className="text-gray-500"> No rakeback (reach Silver for 5%)</span>
                  }
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20">
              ...
              <p className="text-gray-500 text-xs mt-3">
                Rakeback is paid from the 2.5% house fee — the house profit funds your VIP rewards.
              </p>
            </div>
          </div>
        </motion.div>
