  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 8px 32px rgba(139, 69, 88, 0.15)'
      }}>
        ...
        {!emailSent ? (
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '24px' }}>
              ...
              <input
                ...
                onFocus={(e) => {
                  e.target.style.borderColor = 'rgba(139, 69, 88, 0.5)';
            ...
            <button
              ...
              style={{
                width: '100%',
                padding: '14px',
                background: loading ? 'rgba(100, 100, 100, 0.3)' : 'linear-gradient(135deg, #c97586, #a85c6f)',
                border: 'none',
                borderRadius: '8px',
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '16px', display: 'flex', justifyContent: 'center' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#10b981" style={{ width: '48px', height: '48px' }}><path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" /><path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" /></svg>
            </div>
